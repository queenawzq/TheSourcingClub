...
const ACCEPTANCE_FIELDS = "id, org_id, terms_version, signature, accepted_by, accepted_at";
 ...
 */
export async function acceptTerms({ orgId, termsVersion, signature, userId }) {
