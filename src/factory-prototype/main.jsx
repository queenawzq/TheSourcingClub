...
export function FactoryOnboarding({
  ...
  const current = designedStep.terms && (terms || fullTerms)
  ...
  if (stepType === "terms") {
    return (
      <div className="factory-onboarding-section terms-section">
        ...
        {termsOpen && <TermsDialog accountType="factory" language={language} text={content.fullTerms} onClose={() => setTermsOpen(false)} />}
      </div>
    );
  }
