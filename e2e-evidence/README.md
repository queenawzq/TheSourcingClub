...
Recorded 2026-09-04T22:47:54.880Z against `http://127.0.0.1:5173/app.html`.

**69 steps, 51 assertions, 0 failed.**
...
| 2 | Factory code requested | e2e-factory-1788561973015@example.com | [02-factory-code-requested.png](02-factory-code-requested.png) |
| 3 | Factory signed in | code 453028 accepted — no password anywhere | [03-factory-signed-in.png](03-factory-signed-in.png) |
| 4 | Factory organisation | factory: Atelier E2E 1788561973015 | [04-factory-organisation.png](04-factory-organisation.png) |
...
| 16 | Brand code requested | e2e-brand-1788561973015@example.com | [16-brand-code-requested.png](16-brand-code-requested.png) |
| 17 | Brand signed in | code 509587 accepted — no password anywhere | [17-brand-signed-in.png](17-brand-signed-in.png) |
| 18 | Brand organisation | brand: Maison E2E 1788561973015 | [18-brand-organisation.png](18-brand-organisation.png) |
...
| 36 | Factory again code requested | e2e-factory-1788561973015@example.com | [36-factory-again-code-requested.png](36-factory-again-code-requested.png) |
| 37 | Factory again signed in | code 956922 accepted — no password anywhere | [37-factory-again-signed-in.png](37-factory-again-signed-in.png) |
...
| 42 | Admin code requested | e2e-admin-1788561973015@example.com | [42-admin-code-requested.png](42-admin-code-requested.png) |
| 43 | Admin signed in | code 500946 accepted — no password anywhere | [43-admin-signed-in.png](43-admin-signed-in.png) |
...
| 47 | Factory quoting code requested | e2e-factory-1788561973015@example.com | [47-factory-quoting-code-requested.png](47-factory-quoting-code-requested.png) |
| 48 | Factory quoting signed in | code 976934 accepted — no password anywhere | [48-factory-quoting-signed-in.png](48-factory-quoting-signed-in.png) |
...
| 53 | Brand deciding code requested | e2e-brand-1788561973015@example.com | [53-brand-deciding-code-requested.png](53-brand-deciding-code-requested.png) |
| 54 | Brand deciding signed in | code 328067 accepted — no password anywhere | [54-brand-deciding-signed-in.png](54-brand-deciding-signed-in.png) |
...
| 58 | Winning factory sign-in | cold start, no session | [58-winning-factory-sign-in.png](58-winning-factory-sign-in.png) |
| 59 | Winning factory code requested | e2e-factory-1788561973015@example.com | [59-winning-factory-code-requested.png](59-winning-factory-code-requested.png) |
| 60 | Winning factory signed in | code 720154 accepted — no password anywhere | [60-winning-factory-signed-in.png](60-winning-factory-signed-in.png) |
...
| 62 | Brand again sign-in | cold start, no session | [62-brand-again-sign-in.png](62-brand-again-sign-in.png) |
| 63 | Brand again code requested | e2e-brand-1788561973015@example.com | [63-brand-again-code-requested.png](63-brand-again-code-requested.png) |
| 64 | Brand again signed in | code 345101 accepted — no password anywhere | [64-brand-again-signed-in.png](64-brand-again-signed-in.png) |
| 65 | Invite-only chosen | publishing this without inviting anyone used to strand it | [65-invite-only-chosen.png](65-invite-only-chosen.png) |
| 66 | Choose who sees it | ranked by fit against this request, same score the factory sees | [66-choose-who-sees-it.png](66-choose-who-sees-it.png) |
| 67 | Invitations saved |  | [67-invitations-saved.png](67-invitations-saved.png) |
| 68 | Deep link survives a hard refresh | the rewrite works, in dev and in production | [68-deep-link-survives-a-hard-refresh.png](68-deep-link-survives-a-hard-refresh.png) |
| 69 | Session survives reload | onboarding not shown again | [69-session-survives-reload.png](69-session-survives-reload.png) |
