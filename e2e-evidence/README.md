...
Recorded 2026-09-13T19:37:30.120Z against `http://127.0.0.1:5173/app.html`.
...
- ✅ the reference on screen is the stored order number, not one composed in the browser (TSC-000037)
...
- ✅ the crash was reported, under the reference shown (5B38319B)
